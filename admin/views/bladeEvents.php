		...
		if( $events = selectJoinDB("events",$joinData,"t.status = '0'") ){
			for( $i = 0; $i < sizeof($events); $i++ ){
				...
				<td class="text-nowrap">
					...
					<a href="<?php echo "?v={$_GET["v"]}&inviteId={$events[$i]["id"]}" ?>" data-toggle="tooltip" data-original-title="<?php echo direction("Invitees","الدعوات") ?>"><i class="fa fa-close text-primary"></i>
					</a>
