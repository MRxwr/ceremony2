...
<script>
    ...
    function updateCountdown() {
        ...
        if (distance > 0) {
            ...
            if (countdownEl) countdownEl.innerHTML = '<h4 class="text-center" style="grid-column: 1 / -1; padding: 2rem; color: var(--primary);"><?php echo direction("The Event Day is Here!","حان يوم الحدث!") ?></h4>';
        }
    }
